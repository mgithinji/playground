...
// needs to be given before `app.use('/posts', ...)`
app.use(cors());
...
const CONNECTION_URL = 'mongodb+srv://<username>:<password>@cluster0.xq9u6.mongodb.net/myFirstDatabase?retryWrites=true&w=majority';
